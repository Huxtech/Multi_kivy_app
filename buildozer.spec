...
# (str) Package name
package.name = multikivy

# (str) Package domain (needed for android/ios packaging)
package.domain = org.huxtech
...
source.include_patterns = assets/*, assets/images/*.png, data/*.png
...
requirements = python3, kivy==2.3.1, android, pyjnius, charset_normalizer
